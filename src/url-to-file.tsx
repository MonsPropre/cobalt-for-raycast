...
export default function Command() {
  ...
  const Instances = useFetch(
    "https://raw.githubusercontent.com/MonsPropre/cobalt-for-raycast/refs/heads/main/assets/instances.json?token=GHSAT0AAAAAADGGP4XAVU6LXAVMXU425V4M2EGGDVA",
  );
